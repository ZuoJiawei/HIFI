...
u8 mp3_get_info(u8 *pname,__mp3ctrl* pctrl)
{
	...
	if(fmp3&&buf)//内存申请成功
	{ 		
		res=f_open(fmp3,(TCHAR*)pname,FA_READ);//打开文件
...
{ 
	...
	{ 
		...
		iic_flag=AK4495_I2S_Cfg(0x00,16,mp3ctrl->samplerate);	//飞利浦标准,16位数据长度
