...
//All rights reserved									  
////////////////////////////////////////////////////////////////////////////////// 	
#define PCM_DSD_CTRL    PFout(2) //PCM/DSD模式切换   	   		   
//IO方向设置
//#if RED_DRAGONBOARD
...
//#else 
#define SDA_IN()  {IIC_WR=0;GPIOB->MODER&=~(3<<(9*2));GPIOB->MODER|=0<<9*2;}	//PB9输入模式
#define SDA_OUT() {IIC_WR=1;GPIOB->MODER&=~(3<<(9*2));GPIOB->MODER|=1<<9*2;} //PB9输出模式
